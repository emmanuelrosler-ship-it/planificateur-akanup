...
NOM_FEUILLE_DE_CALCUL = "Feuille 1" # <--- ASSUREZ-VOUS QUE CE NOM CORRESPOND À VOTRE GOOGLE SHEET
...
def read_data():
    ...
    try:
        ...
        st.error(f"Impossible de lire la feuille de calcul. Vérifiez que le nom de l'onglet est bien '{NOM_FEUILLE_DE_CALCUL}'. Erreur : {e}")
        return pd.DataFrame(columns=["Participant", "Date"]) # Retourne une table vide en cas d'erreur
